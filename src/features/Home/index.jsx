  ...
  return (
    <div>
      <div className="my-home h-screen px-4 min-[376px]:px-0 sm:px-0">
        <div className="h-2/5 sm:h-3/5"></div>
        <h1 className="text-2xl min-[376px]:text-3xl sm:text-4xl lg:text-5xl xl:text-7xl my-home-title">
          Nhân tướng học steven
        </h1>
        <div className="container mx-auto flex flex-wrap min-[376px]:flex-nowrap sm:flex-nowrap justify-center min-[376px]:mt-4 md:mt-10">
          <button
            type="button"
            className="my-home-btn-1 text-sm min-[376px]:text-sm sm:text-lg md:text-lg xl:text-2xl py-2 px-3 min-[376px]:py-2 min-[376px]:px-3 md:py-3 md:px-5 xl:py-5 xl:px-7 mb-2 min-[375px]:mb-0"
          >
            Đăng ký khóa học
          </button>
          ...
          <button
            type="button"
            className="my-home-btn-1 text-sm min-[376px]:text-sm sm:text-lg md:text-lg xl:text-2xl px-5 min-[376px]:px-5 md:px-8 xl:py-5 xl:px-7 mb-2 min-[375px]:mb-0"
          >
            Đặt lịch tư vấn
          </button>
        </div>
      ...
      <div className="py-10 min-[376px]:py-12 md:py-16 xl:py-24 h-fit my-home__section-2 flex justify-center items-center">
        <div className="container mx-auto px-4 min-[376px]:px-9 sm:px-0">
          <div className="grid justify-items-center">
            ...
            />
            <span className="text-xl min-[376px]:text-xl md:text-3xl xl:text-4xl my-home__section-2-title-1">
              “Mình là Steven,
            </span>
            <span className="text-xl min-[376px]:text-xl md:text-3xl xl:text-4xl my-home__section-2-title-2 mb-4 sm:mb-8 md:mb-6 xl:mb-8">
              thích tắm biển và luận tướng dạo”
            </span>
            <p className="text-sm min-[376px]:text-sm sm:text-xl md:text-lg xl:text-xl w-11/12 md:w-9/12 lg:w-8/12 text-white mb-8 sm:mb-14 md:mb-10 xl:mb-14">
            ...
            <button
              type="button"
              className="my-home__section-2-btn text-sm min-[376px]:text-sm sm:text-xl md:text-lg xl:text-xl py-2 px-3 min-[376px]:py-2 min-[376px]:px-3 md:py-3 md:px-5 xl:py-5 xl:px-7"
            >
              Đăng ký khóa học
            </button>
          </div>
      ...
      <div className="h-fit my-home__section-3">
        <div className="h-full my-home__section-3-bg"></div>
        <div className="py-14 min-[376px]:py-8 sm:py-0 h-fit my-home__section-3-content flex justify-center items-center">
          <div className="container mx-auto px-4 min-[376px]:px-9 lg:px-24">
            <div className="grid justify-items-start mb-4 min-[376px]:mb-8 sm:mb-16">
              ...
              <div className="my-home__section-3-content-title h-10 min-[376px]:h-[2.7rem] md:h-12 xl:h-14">
                <div className="title-decoration w-28 min-[376px]:w-30 md:w-48 xl:w-64"></div>
                <h2 className="text-white text-xl min-[376px]:text-xl md:text-4xl xl:text-5xl title-text">
                  <span className="font-bold">Các nền tảng </span>chính thức
                </h2>
              </div>
            </div>
            <div className="grid grid-cols-5 gap-7 content-center justify-items-center lg:px-8 md:px-2 xl:px-36">
      ...
      <div className="h-fit my-home__section-4 flex justify-center items-center py-0 min-[376px]:py-14 sm:py-32 pb-12 min-[376px]:pb-0">
        <div className="container px-4 min-[376px]:px-9 lg:px-24 mx-auto flex-wrap sm:flex columns-3xs justify-between">
          <div className="flex-none w-full sm:w-3/5 grid justify-items-start h-auto content-center">
            ...
            <div className="my-home__section-3-content-title h-10 min-[376px]:h-[2.7rem] md:h-12 xl:h-14">
              <div className="title-decoration w-16 min-[376px]:w-16 md:w-28 xl:w-36"></div>
              <h2 className="text-white text-xl min-[376px]:text-xl md:text-4xl xl:text-5xl title-text">
                <span className="font-bold">Tâm sự </span>cùng Steven
              </h2>
            </div>
            <p className="text-sm min-[376px]:text-sm sm:text-xl md:text-lg xl:text-xl text-white text-start md:w-10/12 xl:w-3/5 py-4 min-[376px]:py-4 md:py-6 xl:py-8">
            ...
            <button
              type="button"
              className="my-home__section-4-btn text-sm min-[376px]:text-sm sm:text-xl md:text-lg xl:text-xl md:py-3 md:px-5 xl:py-5 xl:px-7 min-[376px]:py-2 min-[376px]:px-3 py-2 px-3"
            >
              Đặt lịch tại đây
            </button>
          </div>
        ...
        <div className="my-home__section-5-content flex justify-center items-center py-8 px-0 min-[376px]:py-12 min-[376px]:px-0 lg:py-16 lg:px-0 md:px-0 md:py-12 px-9 xl:px-0 xl:py-24">
          <div className="container mx-auto px-4 min-[376px]:px-9 lg:px-24">
            <div className="grid justify-items-center">
              ...
              <div className="my-home__section-5-content-title h-10 min-[376px]:h-10 md:h-12 xl:h-14">
                <div className="title-decoration w-[4.7rem] min-[376px]:w-[4.7rem] md:w-[8.5rem] xl:w-44"></div>
                <h2 className="text-white text-xl min-[376px]:text-xl md:text-4xl xl:text-5xl title-text">
                  <span className="font-bold">Thư viện </span>bài viết
                </h2>
              </div>
              <p className="text-sm min-[376px]:text-sm sm:text-xl md:text-lg xl:text-xl text-white text-center md:w-ull lg:w-2/5 xl:w-5/12 py-4 min-[376px]:py-4 md:py-6 xl:py-8">
              ...
              <div class="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:mb-12 md:mb-16 min-[376px]:mb-8 mb-8">
                <article class="flex max-w-xl flex-col items-start justify-start my-blog">
                  ...
                  <div class="mt-2 group relative">
                    <h3 class="text-lg font-semibold leading-6 text-white text-start">
                      <a href="/">
                        <span class="absolute inset-0"></span>
                        Boost your conversion rate
                      </a>
                    </h3>
                    <p class="mt-2 line-clamp-3 text-sm leading-6 text-white text-start">
              ...
              <button
                type="button"
                className="my-home__section-5-btn text-sm min-[376px]:text-sm sm:text-xl md:text-lg xl:text-xl md:py-3 md:px-12 xl:py-5 xl:px-16 min-[376px]:py-2 min-[376px]:px-5 py-2 px-5"
              >
                Xem tất cả
              </button>
            </div>
