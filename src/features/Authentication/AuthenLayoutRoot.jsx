    ...
    return (
        <div className='flex flex-row items-center'>
            ...
            <div className='w-1/2 flex-none h-screen flex justify-center items-center banner'>
                ...
                <h1 className="drop-shadow-[0_35px_35px_rgba(78, 72, 54, 1)] text-2xl min-[376px]:text-3xl sm:text-4xl lg:text-5xl xl:text-6xl banner-title prevent-select mt-72">
